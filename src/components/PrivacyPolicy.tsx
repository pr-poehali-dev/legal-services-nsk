        ...
        <div className="p-6 space-y-6 text-gray-700">
          <section>
            ...
            <p>
              ...
              юридическая консультация может получить о пользователе во время
          ...
          <section>
            ...
            <p>
              ...
              субъекта персональных данных и в соответствии с требованиями
          ...
          <section>
            ...
            <p>
              ...
              последнего обращения, если иное не предусмотрено
              законодательством.
            </p>
          </section>
          ...
          <section>
            <h3 className="text-xl font-semibold mb-3 text-primary">
              6. Права субьекта персональных данных
            </h3>
            <p>Вы имеете право:</p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
          ...
          <section>
            ...
            <p>
              Мы принимаем необходимые технические и организационные меры для
          ...
          <section>
            <p className="text-sm text-gray-600">
              ...
              предварительного уведомления. Актуальная версия размещается на
              сайте.
            </p>
          </section>
        </div>
