...
const RealLicenseStoriesSection = () => {
  const stories = [
    {
      name: "Михаил",
      age: 34,
      profession: "водитель такси",
      problem: "Остановили с 0.6 промилле, протокол на лишение прав на 2 года",
      result: "Дело закрыто, права сохранены",
      resultAmount: "Работа сохранена",
      duration: "3 недели",
      quote: "Без прав — без работы, без денег на семью. Думал всё, конец. Юрист нашёл нарушения в протоколе — не было понятых, алкотестер без поверки. Суд закрыл дело!",
    ...
    },
    {
      ...
      problem: "Отказ от медосвидетельствования, угроза лишения прав + штраф 30 000₽",
      result: "Штраф заменили на предупреждение",
      resultAmount: "Права + работа",
      duration: "2 недели",
      quote: "Испугался медосвидетельствования, отказался — думал, лучше откажусь, чем лишат. ГИБДД сказали — всё равно лишим. Юрист доказал, что инспектор нарушил процедуру, незаконно требовал освидетельствование. Суд отменил протокол.",
      increase: "Сохранил лицензию",
      icon: "Truck",
    ...
    },
    {
      ...
      age: 29,
      profession: "курьер",
      problem: "Повторное лишение прав за алкоголь — грозила уголовная статья",
      result: "Переквалифицировали на административное нарушение",
      resultAmount: "Избежал тюрьмы",
      duration: "1 месяц",
      quote: "Уже был лишён прав год назад. Снова остановили — думал, статья УК, тюрьма. Адвокат доказал, что первое лишение было незаконным, оспорили его. Суд переквалифицировал на административку, избежал уголовки.",
      increase: "Свобода сохранена",
      icon: "Shield",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-block bg-green-100 text-green-700 px-6 py-2 rounded-full font-bold mb-4">
            ✅ РЕАЛЬНЫЕ ИСТОРИИ ЗАЩИТЫ
          </div>
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">
            Они защитились — и сохранили права и работу
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Истории людей, которые не сдались и выиграли дело с нашей помощью
          </p>
        </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">Дело выиграно</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                <p className="text-3xl font-bold text-white mb-2">
                  73% дел закрываются при правильной защите
                </p>
                <p className="text-green-100 text-lg">
                  Без юриста лишают права в 98% случаев. С профессиональной защитой — закрываем 73% дел или снижаем наказание.
                  Работаем на результат — не выиграли, вернём деньги.
                </p>
              </div>
...
export default RealLicenseStoriesSection;
