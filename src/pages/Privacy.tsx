          ...
          <div className="prose prose-slate max-w-none space-y-6 text-foreground">
            <section>
              ...
              <p className="mb-4">
                ...
                персональных данных, предпринимаемые ЮрСервис НСК (далее –
                «Компания»).
              </p>
              <p>
                Компания обязуется соблюдать конфиденциальность персональных
            ...
            <section>
              ...
              <p>
                Персональные данные собираются только с согласия субъекта
                персональных данных и используются исключительно для
            ...
            <section>
              ...
              <p>
                ...
                для достижения целей обработки, но не более срока,
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  Получать информацию о составе и содержании своих персональных
                  данных
                </li>
            ...
            <section>
              ...
              <p>
                Компания принимает необходимые и достаточные правовые,
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mb-2">
                  Email:{" "}
                  <a
                    href="mailto:info@jurservice-nsk.ru"
                    className="text-primary hover:underline"
                  >
                    info@jurservice-nsk.ru
                  </a>
                </p>
                <p>Адрес: г. Новосибирск, ул. Ленина, 1</p>
              </div>
            </section>
